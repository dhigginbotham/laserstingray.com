...
var bindController=function(t,n,e,i){var r,a,d,u,b,o,f,l,g;return r={},i.binding=!1,a=!1,u={},b=function(t){return"undefined"!=typeof t&&e.extend(r,t),o(),i},i.bind=o=function(){if(a){i.binding=!1;for(var t=0;t<d.length;++t){var n,e;n=d[t],e=r[n.getAttribute("data-bind")],e&&(n.getAttribute("data-bound")||n.setAttribute("data-bound",!0),null===n.getAttribute("data-bind-clean")&&n.setAttribute("data-bind-clean",e),n.setAttribute("data-bind-dirty",e),n.innerText=e)}}},i.update=f=function(){i.binding=!0,d=n.getElementsByTagName("*");for(var t=0;t<d.length;++t){var a,u;if(null===d[t].getAttribute("data-bound")){if(a=d[t].getAttribute("data-bind"),null===a)continue;u=d[t].innerText?d[t].innerText:d[t].getAttribute("data-bind-clean"),r[a]=u&&!r[a]?u:null}}e(n).ready(g)},l=function(t){var n,e,i,a;return n=t.split("."),e={},i=!0,(a=function(t){return e=i?r[t]:e[t],i=!1,n.length?a(n.shift()):e})(n.shift())},i.set=function(t,n){var e=l(t);"undefined"!=typeof e&&(e=n),o()},g=function(){a=!0,o(),i.model=r,i.state=d},f(),b}(window,document,jQuery,{});
