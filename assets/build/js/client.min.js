...
$.fn.serializeObject=function(){var t={},i=this.serializeArray();return $.each(i,function(){void 0!==t[this.name]?(t[this.name].push||(t[this.name]=[t[this.name]]),t[this.name].push(this.value||"")):t[this.name]=this.value||""}),t};var dotLookup=function(t,i){for(var e=t.split("."),n=e.pop();t=e.shift();)if(i=i[t],"object"!=typeof i||!i)return;return i[n]};
...
var bindController=function(t,n,e,i){var d,r,u,a,o,b,f;return d={},i.binding=!1,r=!1,u=[],a=function(t){return"object"==typeof t&&e.extend(d,t),o(),i},i.bindElements=o=function(t){if(r){i.binding=!1;for(var n=0;n<u.length;++n){var e,a,o,b;a=u[n],b=t?t:a.getAttribute("data-bind"),o=~b.indexOf(".")?dotLookup(b,d):d[b],b==a.getAttribute("data-bind")&&"undefined"!=typeof o&&(a.getAttribute("data-bound")||a.setAttribute("data-bound",!0),null===a.getAttribute("data-bind-first")&&a.setAttribute("data-bind-first",encodeURIComponent(o)),e=a.getAttribute("data-bind-count"),null===e?a.setAttribute("data-bind-count",1):a.setAttribute("data-bind-count",parseInt(e)+1),a.innerHTML=o)}}return i},i.update=b=function(t,e){i.binding=!0;var r,a;"function"==typeof t&&"undefined"==typeof e&&(e=t,t=null),r=t?t:n,a=r.getElementsByTagName("*");for(var o=0;o<a.length;++o){var b,f;null===a[o].getAttribute("data-bound")&&(b=a[o].getAttribute("data-bind"),null!==b&&(f=a[o].innerHTML?a[o].innerHTML:a[o].getAttribute("data-bind-first"),~b.indexOf(".")||(d[b]=f&&!d[b]?f:null),u.push(a[o])))}return"undefined"!=typeof e&&e(),i},i.orig=function(t){if("undefined"!=typeof t)for(var n=0;n<u.length;++n){var e=u[n];if(e.getAttribute("data-bind")==t&&null!==e.getAttribute("data-bind-first"))return i.set(t,decodeURIComponent(e.getAttribute("data-bind-first")))}return!1},i.set=function(t,n,e){return d[t]=n,e&&(t=null),o(t),i},f=function(){r||(r=!0),o(),i.model=d,i.state=u},b(function(){e(n).ready(f)}),a}(window,document,jQuery,{});
