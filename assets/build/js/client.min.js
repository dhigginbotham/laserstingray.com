...
var bindController=function(t,n,e,i){var u,d,a,r,b,o,f,l;return u={},i.binding=!1,d=!1,a=[],r={},b=function(t){return"object"==typeof t&&e.extend(u,t),o(),i},i.bindElements=o=function(t){if(d){i.binding=!1;for(var n=0;n<a.length;++n){var e,r,b,o;if(r=a[n],o="undefined"!=typeof t?t:r.getAttribute("data-bind"),b=u[o],o==r.getAttribute("data-bind")){if("undefined"==typeof b)continue;r.getAttribute("data-bound")||r.setAttribute("data-bound",!0),null==r.getAttribute("data-bind-value")&&r.setAttribute("data-bind-value",b),e=r.getAttribute("data-bind-count"),null===e?r.setAttribute("data-bind-count",1):r.setAttribute("data-bind-count",++e),r.innerHTML=b}}}},i.update=f=function(t,e){i.binding=!0;var d,r;"function"==typeof t&&"undefined"==typeof e&&(e=t,t=null),d=t?t:n,r=d.getElementsByTagName("*");for(var b=0;b<r.length;++b){var o,f;if(null===r[b].getAttribute("data-bound")){if(o=r[b].getAttribute("data-bind"),null===o)continue;f=r[b].innerHTML?r[b].innerHTML:r[b].getAttribute("data-bind-value"),u[o]=f&&!u[o]?f:null,a.push(r[b])}}"undefined"!=typeof e&&e()},i.set=function(t,n){u[t]=n,o(t)},l=function(){d||(d=!0),o(),i.model=u,i.state=a},f(function(){e(n).ready(l)}),b}(window,document,jQuery,{});
