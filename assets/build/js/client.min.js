...
var messagingController=function(e,n,u,i){var t,o,s,r,d,l;return o={selector:"#msgContainer"},r={queue:[],log:[],visible:!1,ready:!1},s=function(){t=u(o.selector),r.ready=!0,l()},l=function(){var e=function(e){d(e),l()};if(!r.visible&&r.queue.length){var n=r.queue.shift();e(n)}},d=function(n){r.log.push(n),r.visible=!0,t.find("p").text(n.text),t.hasClass("hidden")&&t.removeClass("hidden"),e.setTimeout(function(){r.queue.length||t.addClass("hidden"),r.visible=!1,n.func&&n.func(),l()},n.delay)},i.toggle=function(e){r.queue.push(e),r.ready&&l()},u(n).ready(s),function(e){return e&&u.extend(o,e),i}}(window,document,jQuery,{});