...
var messagingController=function(e,n,t,u){var i,o,l,s,r,g;return o={selector:"#msgContainer"},s={queue:[],log:[],visible:!1},l=function(){i=t(o.selector),g()},g=function(){var e=function(e){s.log.push(e),r(e.text,e.time),g()};if(!s.visible&&s.queue.length){var n=s.queue.shift();e(n)}},r=function(n,t){s.visible=!0,i.find("p").text(n+" :: "+s.log.length),i.removeClass("hidden"),e.setTimeout(function(){s.queue.length||i.addClass("hidden"),s.visible=!1,g()},t)},u.toggle=function(e){s.queue.push(e),console.log(s.queue.length),g()},t(n).ready(l),function(e){return e&&t.extend(o,e),u}}(window,document,jQuery,{});