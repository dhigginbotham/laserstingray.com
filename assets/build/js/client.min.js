...
var bindController=function(t,n,e,u){var a,r,d,i,o,b;return a={},u.bound=!1,d=function(t){return"undefined"!=typeof t&&e.extend(a,t),i(),u},u.bind=i=function(){for(var t=0;t<r.length;++t){var n=a[r[t].getAttribute("data-bind")];n&&(r[t].getAttribute("data-bound")||r[t].setAttribute("data-bound",!0),r[t].innerText=n)}},u.update=o=function(t){u.bound=!0,r=t?t.getElementsByTagName("*"):n.getElementsByTagName("*");for(var e=0;e<r.length;++e){var d,o;if(null===r[e].getAttribute("data-bound")){if(d=r[e].getAttribute("data-bind"),null===d)continue;o=r[e].innerText?r[e].innerText:r[e].getAttribute("data-val"),a[d]=o&&!a[d]?o:null}}i()},u.set=function(t,n){a[t]=n,i()},b=function(){u.bound||o(),u.model=a,u.state=r},o(),e(n).ready(b),d}(window,document,jQuery,{});
