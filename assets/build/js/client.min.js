...
var bindController=function(t,e,n,i){var r,a,d,u,b,o,l,f,s;return l=helperUtils.get,s=helperUtils.set,r={},a=!1,d=[],u=function(t){return"object"==typeof t&&n.extend(r,t),b(),i},i.bindElements=b=function(t){if(a)for(var e=0;e<d.length;++e){var n,u,b,o,f;u=d[e],f=t?t:u.getAttribute("data-bind"),o=~f.indexOf(".")?l(f,r):r[f],b=u.innerHTML,b&&b==o||f==u.getAttribute("data-bind")&&"undefined"!=typeof o&&(u.getAttribute("data-bound")||u.setAttribute("data-bound",!0),o&&null===u.getAttribute("data-bind-first")&&u.setAttribute("data-bind-first",encodeURIComponent(o)),o&&null===u.getAttribute("data-bind-last")&&u.setAttribute("data-bind-last",o),b&&u.getAttribute("data-bind-last")!=b&&u.setAttribute("data-bind-last",b),n=u.getAttribute("data-bind-count"),null===n?u.setAttribute("data-bind-count",1):u.setAttribute("data-bind-count",parseFloat(n)+1),u.innerHTML=o)}return i},i.update=o=function(t,n){var a,u;"function"==typeof t&&"undefined"==typeof n&&(n=t,t=null),a=t?t:e,u=a.getElementsByTagName("*");for(var b=0;b<u.length;++b){var o,l;null===u[b].getAttribute("data-bound")&&(o=u[b].getAttribute("data-bind"),null!==o&&(l=u[b].innerHTML?u[b].innerHTML:u[b].getAttribute("data-bind-first"),s(r,o,l),d.push(u[b])))}return"undefined"!=typeof n&&n(),i},i.revert=function(t,e){var n=["first","last"];if("undefined"==typeof e&&(e=t,t="first"),n.indexOf(t)>-1)for(var r=0;r<d.length;++r){var a=d[r];if(a.getAttribute("data-bind")==e&&null!==a.getAttribute("data-bind-"+t))return i.set(e,decodeURIComponent(a.getAttribute("data-bind-"+t)))}return i},i.set=function(t,e,n){return s(r,t,e),n&&(t=null),b(t),i},f=function(){a||(a=!0),b(),i.model=r,i.state=d},o(function(){n(e).ready(f)}),u}(window,document,jQuery,{});
