...
var messagingController=function(e,n,t,i){var u,o,r,l,s,d;return o={selector:"#msgContainer"},l={queue:[],log:[],visible:!1,ready:!1},r=function(){u=t(o.selector),l.ready=!0,d()},d=function(){var e=function(e){l.log.push(e),s(e.text,e.time),d()};if(!l.visible&&l.queue.length){var n=l.queue.shift();e(n)}},s=function(n,t){l.visible=!0,u.find("p").text(n+" :: "+l.log.length),u.removeClass("hidden"),e.setTimeout(function(){l.queue.length||u.addClass("hidden"),l.visible=!1,d()},t)},i.toggle=function(e){l.queue.push(e),l.ready&&d()},t(n).ready(r),function(e){return e&&t.extend(o,e),i}}(window,document,jQuery,{});