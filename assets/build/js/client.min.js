...
var bindController=function(t,n,e,i){var a,d,u,r,b,o,l,f;return a={},i.binding=!1,d=!1,r={},b=function(t){return"undefined"!=typeof t&&e.extend(a,t),o(),i},i.bind=o=function(){if(d){i.binding=!1;for(var t=0;t<u.length;++t){var n,e;n=u[t],e=a[n.getAttribute("data-bind")],e&&(n.getAttribute("data-bound")||n.setAttribute("data-bound",!0),null===n.getAttribute("data-bind-clean")&&n.setAttribute("data-bind-clean",e),n.setAttribute("data-bind-dirty",e),n.innerText=e)}}},i.update=l=function(t){i.binding=!0,u="undefined"!=typeof t?t.getElementsByTagName("*"):n.getElementsByTagName("*");for(var d=0;d<u.length;++d){var r,b;if(null===u[d].getAttribute("data-bound")){if(r=u[d].getAttribute("data-bind"),null===r)continue;b=u[d].innerText?u[d].innerText:u[d].getAttribute("data-bind-clean"),a[r]=b&&!a[r]?b:null}}e(n).ready(f)},i.set=function(t,n){a[t]=n,o()},f=function(){d=!0,o(),i.model=a,i.state=u},l(),b}(window,document,jQuery,{});
