...
var bindController=function(t,n,e,i){var u,d,a,o,r,b,f;return u={},i.binding=!1,d=!1,a=[],o=function(t){return"object"==typeof t&&e.extend(u,t),r(),i},i.bindElements=r=function(t){if(d){i.binding=!1;for(var n=0;n<a.length;++n){var e,o,r,b;o=a[n],b="undefined"!=typeof t?t:o.getAttribute("data-bind"),r=~b.indexOf(".")?dotLookup(b,u):u[b],b==o.getAttribute("data-bind")&&"undefined"!=typeof r&&(o.getAttribute("data-bound")||o.setAttribute("data-bound",!0),null==o.getAttribute("data-bind-value")&&o.setAttribute("data-bind-value",r),e=o.getAttribute("data-bind-count"),null===e?o.setAttribute("data-bind-count",1):o.setAttribute("data-bind-count",++e),o.innerHTML=r)}}},i.update=b=function(t,e){i.binding=!0;var d,o;"function"==typeof t&&"undefined"==typeof e&&(e=t,t=null),d=t?t:n,o=d.getElementsByTagName("*");for(var r=0;r<o.length;++r){var b,f;if(null===o[r].getAttribute("data-bound")){if(b=o[r].getAttribute("data-bind"),null===b)continue;f=o[r].innerHTML?o[r].innerHTML:o[r].getAttribute("data-bind-value"),~b.indexOf(".")||(u[b]=f&&!u[b]?f:null),a.push(o[r])}}"undefined"!=typeof e&&e()},i.set=function(t,n){u[t]=n,r(t)},f=function(){d||(d=!0),r(),i.model=u,i.state=a},b(function(){e(n).ready(f)}),o}(window,document,jQuery,{});
