...
var bindController=function(t,n,e,i){var a,u,r,d,b,o,l,f,c;return a={},i.binding=!1,u=!1,d={},b=function(t){return"undefined"!=typeof t&&e.extend(a,t),o(),i},i.bindElements=o=function(){if(u){i.binding=!1;for(var t=0;t<r.length;++t){var n,e;if(n=r[t],e=a[n.getAttribute("data-bind")]){n.getAttribute("data-bound")||n.setAttribute("data-bound",!0),null===n.getAttribute("data-bind-clean")&&n.setAttribute("data-bind-clean",e),n.setAttribute("data-bind-dirty",e);var d=n.getAttribute("data-bind-count");null===d?n.setAttribute("data-bind-count",1):n.setAttribute("data-bind-count",++d),n.innerText=e}}}},i.update=l=function(t){i.binding=!0,r=n.getElementsByTagName("*");for(var e=0;e<r.length;++e){var u,d;if(null===r[e].getAttribute("data-bound")){if(u=r[e].getAttribute("data-bind"),null===u)continue;d=r[e].innerText?r[e].innerText:r[e].getAttribute("data-bind-clean"),a[u]=d&&!a[u]?d:null}}t&&t()},f=function(t,n){for(var e=t.split("."),i=e.pop();t=e.shift();)if(n=n[t],"object"!=typeof n||!n)return;return n[i]},i.set=function(t,n){a[t]=n,o()},c=function(){u||(u=!0),o(),i.model=a,i.state=r},l(function(){e(n).ready(c)}),b}(window,document,jQuery,{});
